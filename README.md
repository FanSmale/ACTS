...
1. Overall framework
![alt text](https://github.com/FanSmale/ACTS/framework.png)
...
2. Sampling bias
![alt text](https://github.com/FanSmale/ACTS/samplingbias.png)
...
![alt text](https://github.com/FanSmale/ACTS/adaptability.png)
